...
node scripts/extract-font-metrics.mjs \
  ...
  --map "Barlow Medium=fonts/Barlow-Medium.ttf:regular" \
  ...
  --map "Roboto Slab Medium=fonts/RobotoSlab-Medium.ttf:regular" \
  ...
  --map "Comfortaa Light=fonts/Comfortaa-Light.ttf:regular" \
  --map "Open Sans=fonts/OpenSans-Regular.ttf:regular,fonts/OpenSans-Bold.ttf:bold" \
  --map "Open Sans ExtraBold=fonts/OpenSans-ExtraBold.ttf:regular" \
