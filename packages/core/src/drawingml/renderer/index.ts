...
// Color utility (canonical source: color/color-math.ts)
export { colorToRgba } from '../../color/index.js';
...
// Text renderer
export { renderTextBody, measureTextBodyHeight, clearMeasurementCache, measureCursorPosition } from './text-renderer.js';
