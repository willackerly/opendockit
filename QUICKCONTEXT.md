...
- **4,493 tests** passing (1,768 core + 331 elements + 208 render + 370 pptx + 1,663 pdf-signer + 129 docx + 24 pdf), typecheck clean (pdf-signer DOM types fixed 2026-03-11)
