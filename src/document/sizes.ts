 ...
 * Native implementation — identical values to pdf-lib's PageSizes.
 */
...
export const PageSizes = {
  ...
  A8: [147.40, 209.76] as [number, number],
  A9: [104.88, 147.40] as [number, number],
  A10: [73.70, 104.88] as [number, number],
  ...
  B5: [498.90, 708.66] as [number, number],
  B6: [354.33, 498.90] as [number, number],
  ...
  RA0: [2437.80, 3458.27] as [number, number],
  RA1: [1729.13, 2437.80] as [number, number],
  RA2: [1218.90, 1729.13] as [number, number],
  RA3: [864.57, 1218.90] as [number, number],
  ...
  SRA4: [637.80, 907.09] as [number, number],
  Executive: [521.86, 756.00] as [number, number],
  Folio: [612.00, 936.00] as [number, number],
  Legal: [612.00, 1008.00] as [number, number],
  Letter: [612.00, 792.00] as [number, number],
  Tabloid: [792.00, 1224.00] as [number, number],
} as const;
